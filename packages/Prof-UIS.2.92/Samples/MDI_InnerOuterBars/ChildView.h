...
protected:
	...
	afx_msg void OnChildBuild();
	afx_msg void OnChildCompile();
	afx_msg void OnChildDebug();
	afx_msg void OnChildRebuild();
	afx_msg void OnChildStopBuild();
	afx_msg void OnChildStopDbg();
	//}}AFX_MSG

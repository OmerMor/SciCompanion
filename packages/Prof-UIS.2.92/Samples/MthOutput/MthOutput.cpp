// MthOutput.cpp : Defines the class behaviors for the application.
//
...
BOOL CDemoApp::InitInstance()
{
	...
	// create main MthOutput frame window
	if (!pFrame->LoadFrame(IDR_MAINFRAME))
		return FALSE;

	// try to load shared MthOutput menus and accelerator table
...
CMainFrame * pFrame =
	...
	// create a new MthOutput child window
